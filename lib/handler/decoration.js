...
module.exports =  {
  ...
  annotation_custom_smell (smell, editoR) {

      var marker = editoR.markBufferRange(smell.range)
      var decoration_line_nr = editoR.decorateMarker(marker, {type: 'line-number', class: 'line-number-blue'})
      var decoration_token = editoR.decorateMarker(marker, {type: 'highlight', class: 'highlight-blue'})
      var path = editoR.getPath()
